...
public class FileListAdapter extends RecyclerView.Adapter {
    ...
    public FileListAdapter(FileClickInterface fileClickInterface) {
        this.fileClickInterface = fileClickInterface;
    }

    @Override
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_files_list, parent, false);
