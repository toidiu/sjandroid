...
public class DbAddUploadFileAction extends BaseAction {
    ...
    public ActionResult processRequest(EventServiceImpl service, ActionRequest actionRequest, Bundle bundle) {
        ...
        DbAddUploadFileActionHelper helper = PsDbAddUploadFileAction.helper(actionRequest.getArguments(getClass().getClassLoader()));
        ...
        try {
            ...
            return new DbAddUploadFileActionEventSuccess();
        } catch (SQLException e) {
            e.printStackTrace();
            return new DbAddUploadFileActionEventFailure();
        }
    }
